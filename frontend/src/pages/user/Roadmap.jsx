      ...
      <Card className="bg-white border-slate-200 shadow-sm">
        <form onSubmit={handleGenerateRoadmap} className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100 text-xs">
            <span className="font-bold text-slate-700 flex items-center mr-1">
      ...
      {activeRoadmap ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3 text-center">
                  ...
                  <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200">
                    <span className="text-[10px] font-bold uppercase text-emerald-600">Target Match</span>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs pt-2">
                  <div className="p-2 bg-slate-50 rounded-lg text-slate-700 flex justify-between">
                  ...
                  <div className="p-2 bg-slate-50 rounded-lg text-slate-700 flex justify-between">
                    ...
                    <span className="font-bold text-slate-900">~{activeRoadmap.total_hours} hrs</span>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Target Role Roadmap</span>
                <h2 className="text-xl font-bold text-slate-900">{activeRoadmap.target_role}</h2>
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-xs text-right shrink-0">
                <span className="text-[10px] font-bold uppercase text-emerald-600">Potential Readiness</span>
                    ...
                    >
                      <div className="flex items-center space-x-3 flex-1 mr-4">
                        ...
                        <div className="overflow-hidden">
                          <div className="flex items-center space-x-2">
                            <h3 className="text-base font-bold text-slate-900 truncate">{week.title}</h3>
                            <span className="text-[10px] font-semibold text-slate-500 bg-slate-100 px-2 py-0.5 rounded shrink-0">
                              ~{week.estimated_hours}h
                            </span>
                          </div>
                          <p className="text-xs text-slate-500 truncate mt-0.5">{week.theme}</p>
                        </div>
                      </div>
                      ...
                      <div className="p-4 sm:p-6 space-y-6 bg-slate-50/40">
                        ...
                        {week.goals?.length > 0 && (
                          <div className="space-y-1.5 text-xs">
                            <h4 className="font-bold text-slate-700 uppercase text-[10px] tracking-wider">Weekly Goals:</h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
                              {week.goals.map((g, i) => (
                                <div key={i} className="flex items-center space-x-1.5 text-slate-700 bg-white p-2 rounded-lg border border-slate-100">
                        ...
                        <div className="space-y-2">
                          <h4 className="font-bold text-slate-700 uppercase text-[10px] tracking-wider">Weekly Action Tasks:</h4>
                        ...
                        <div className="p-3 bg-white rounded-xl border border-slate-200 text-xs flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              <span className="font-bold text-slate-800">Weekly Milestone: </span>
                              <span className="text-slate-600">{week.milestone}</span>
                            </div>
                          </div>
                          <span className="text-[10px] font-extrabold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded shrink-0">
        ...
        <Card className="text-center py-16 px-6 border-dashed border-2 border-slate-200">
          <div className="max-w-md mx-auto space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-800">No career roadmap generated yet</h3>
            ...
            <div className="space-y-4 text-xs">
              <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-bold text-slate-900">{selectedTask.skill}</span>
                </div>
                <div className="flex items-center space-x-2">
                  {getTaskBadge(selectedTask.type)}
                  <span className="text-slate-500 font-semibold">~{selectedTask.estimated_hours}h</span>
                </div>
              </div>
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-slate-900">Expected Capability Outcome:</h4>
                <p className="text-slate-600 bg-emerald-50/40 p-3 rounded-xl border border-emerald-200 leading-relaxed">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 space-y-1 text-[11px]">
                <div>
                  <strong className="text-slate-700">Related Job Requirement: </strong>
                  <span className="text-slate-600">{selectedTask.related_job_req}</span>
                </div>
                <div>
                  <strong className="text-slate-700">Estimated Match Impact: </strong>
                  <span className="text-brand-700 font-bold">{selectedTask.ats_impact}</span>
                </div>
              </div>

              {/* Status Update Buttons */}
              <div className="space-y-2 pt-2 border-t border-slate-100">
                <span className="font-bold text-slate-700">Set Task Status:</span>
